...
<div class="container-fluid">
    <h3 class="text-dark mb-4">Jobs<i class="fa fa-plus-circle" style="float: right;/*vertical-align: middle;*/cursor: pointer;"></i></h3>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col sl-ats-job-filters" style="display: flex;justify-content: space-around;padding: 10px;/*box-shadow: 0px 0px 10px;*/">
                    ...
                    <div class="dropdown"><button class="btn btn-primary dropdown-toggle" aria-expanded="false" data-bs-toggle="dropdown" type="button">Job Type </button>
                        <div class="dropdown-menu"><a class="dropdown-item" href="#">First Item</a><a class="dropdown-item" href="#">Second Item</a><a class="dropdown-item" href="#">Third Item</a></div>
                    </div>
